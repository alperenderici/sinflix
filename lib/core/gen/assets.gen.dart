...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [appleLogo, facebookLogo, googleLogo];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/sinflix_logo.png
  AssetGenImage get sinflixLogo =>
      const AssetGenImage('assets/images/sinflix_logo.png');

  /// File path: assets/images/sinflix_splash.png
  AssetGenImage get sinflixSplash =>
      const AssetGenImage('assets/images/sinflix_splash.png');
